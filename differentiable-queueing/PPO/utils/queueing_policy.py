...
class BasePolicy(ActorCriticPolicy, ABC):
    ...
    @abstractmethod
    def action_policy(self, latent_pi: torch.Tensor, obs: torch.Tensor):
        pass
    ...
    def forward(self, obs: torch.Tensor, deterministic: bool = False):        
        ...
        action, action_probs = self.action_policy(obs)
    ...
    def evaluate_actions(self, obs: torch.Tensor, actions: torch.Tensor) -> Tuple[torch.Tensor, Optional[torch.Tensor]]:
        ...
        action, action_probs = self.action_policy(latent_pi, obs)
